...
Both platforms have the exact same code deployed to them. The current number of commits stands at 73. Each commit represents a large or small adjustments and is described with a comment as to what was done.
